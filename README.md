...
- **プロンプト編集・プリセット管理** - 議事録・ととのえ生成時のAIプロンプトを確認・編集可能、プリセットとして複数保存・切替
...
- **会議アプリ自動検知** - Zoom / Teams / Google Meet / Webex を監視し、会議開始をバルーン通知。クリックで録音を自動開始。Zoomはウィンドウタイトル検証で会議中のみ検知
